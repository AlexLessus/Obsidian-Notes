...
%% Fundamentar los permisos y restricciones a los usuarios. Dar a conocer las politicas antes de restringir acceso a la red %%
...
- Integridad.
- Control de acceso.
- No repudio.%% Ser capaces de comprobar lo que hace el usuario %%
