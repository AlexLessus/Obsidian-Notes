Se encarga de los aspectos de diseño, instalación y actualización de la red.

- **Objetivo**: Mantener un inventario preciso de los dispositivos y sus configuraciones.
- **Actividades**: Definir parámetros de red, gestionar nombres de dispositivos y mantener registros de versiones de software.
...
-![[Pasted image 20260128000159.png]]
...
%%
Auto-discovery 
	Escanea/Descubre las redes disponibles 
Auto-Mapping
	Te hace un mapa de los dispositivos
Mesh
%%
...
[[Administración de redes]] -- [[1.2 Fallas]]
