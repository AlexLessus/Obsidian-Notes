...
# Agiles
### Scrum
Se basa en ciclos de trabajo cortos llamados **Sprints** (generalmente de 1 a 2 semanas). Es ideal para proyectos con requerimientos cambiantes. Se apoya en roles definidos (Scrum Master, Product Owner) y ceremonias (Daily, Retrospective).
...
El [scrum master](https://rightpeoplegroup.com/scrum-consultants/scrum-master-en/ "Scrum Master") puede tener dificultades para mantener al equipo en el camino.
...
## Kanban
 Se centra en la visualización del flujo de trabajo mediante tableros. A diferencia de Scrum, no tiene tiempos fijos, sino que se enfoca en el "trabajo en curso" (WIP) para evitar cuellos de botella. Es muy común en equipos de mantenimiento o soporte web.
